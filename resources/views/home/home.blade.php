...
<div class="fullscreen landing parallax" style="background-image:url('./home/images/txwvwcxidjzrchjbftic.jpg');" data-img-width="2000" data-img-height="1333" data-diff="100">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          ...
          <!-- /.logo -->
          <div class="logo wow fadeInDown"> <a href=""><img src="./home/images/logo.png" alt="logo"></a></div>
          ...
          <div class="head-btn wow fadeInLeft">
            <a href="{{ route('auth.signup') }}" class="btn-primary">SignUp</a>
            <a href="{{ route('auth.signin') }}" class="btn-default">SignIn</a>
          </div>
          ...
          <div class="signup-header wow fadeInUp">
            ...
            <!-- <form class="form-header" action="http://moxdesign.us10.list-manage.com/subscribe/post" role="form" method="POST" id="#"> -->
              ...
              <div class="form-group last">
                <input type="submit" class="btn btn-warning btn-block btn-lg" value="Signin">
              </div>
...
<div id="menu">
  <nav class="navbar-wrapper navbar-default" role="navigation">
    <div class="container">
        ...
        <a class="navbar-brand site-name" href="#top"><img src="./home/images/logo2.png" alt="logo"></a>
        </div>
  ...
  <div class="container">
    ...
    <!-- /.intro image -->
      <div class="col-md-6 intro-pic wow slideInLeft">
        <img src="./home/images/intro-image.jpg" alt="image" class="img-responsive">
      </div>  
    ...
    <div class="row row-feat">
      ...
      <!-- /.feature image -->
        <div class="feature-img">
          <img src="./home/images/feature-image.jpg" alt="image" class="img-responsive wow fadeInLeft">
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 feature-2-pic wow fadeInRight">
        <img src="./home/images/feature2-image.jpg" alt="macbook" class="img-responsive">
      </div>          
    </div>        
...
<!-- /.download section -->
<div id="download">
  <div class="action fullscreen parallax" style="background-image:url('./home/images/txwvwcxidjzrchjbftic.jpg');" data-img-width="2000" data-img-height="1333" data-diff="100">
    <div class="overlay">
      <div class="container">
         ...
         <div id="owl-testi" class="owl-carousel owl-theme wow fadeInUp">
          ...
          <div class="testi-item">
            <div class="client-pic text-center">
              ...
              <!-- /.client photo -->
              <img src="./home/images/client.jpg" alt="client">
            </div>
            <div class="box">
...
<!-- /.contact section -->
<div id="contact">
  <div class="contact fullscreen parallax" style="background-image:url('./home/images/txwvwcxidjzrchjbftic.jpg');" data-img-width="2000" data-img-height="1334" data-diff="100">
    <div class="overlay">
      <div class="container">
